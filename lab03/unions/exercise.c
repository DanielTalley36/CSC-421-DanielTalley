#include <stdio.h>
  ...
  union charint{
    ...
    int main() {
        ...
        union charint intCharacters = {{1853169737, 1936876900, 1684955508, 1768838432, 561213039, 0}};
      // where is the char strings coming from? ^ How do these come out as chars?// 
        /* testing code */
        printf("[");
